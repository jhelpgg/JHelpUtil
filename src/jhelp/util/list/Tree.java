...
public class Tree<INFORMATION>
{
     ...
     * @param searchMode        Way to search in the tree. See {@link SearchMode}
     ...
     */
    public Tree<INFORMATION> searchBranch(final TestFoundListener<INFORMATION> testFoundListener, final SearchMode
