...
/**
 * Abstract class that implements {@link ActionEach} for doing default exception and error catching : print them in
 * console.
 *
        ...
        implements ActionEach<ELEMENT>
{
     ...
     * {@inheritDoc}
     *
     * @param element Element with the error happen
     ...
     * {@inheritDoc}
     *
     * @param element   Element with the exception happen
