...
public class ArrayDouble
{
   ...
   public void add(final double real)
   {
      ...
      this.sorted = (this.size == 0) || ((this.sorted == true) && (this.array[this.size - 1] <= real));
   ...
   public void insert(final double real, int index)
   {
      ...
      this.sorted = (this.sorted == true) && ((index == 0) || (real >= this.array[index - 1])) && (real <= this.array[index]);
