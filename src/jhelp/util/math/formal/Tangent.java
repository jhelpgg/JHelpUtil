        ...
        extends UnaryOperator
{
     ...
     *
     * @param parameter Function to apply tangent on it
     */
    ...
    public Function derive(final Variable variable)
    {
        ...
        return Function.createMultiplication(d, Function.createAddition(Constant.ONE,
                                                                        Function.createMultiplication(this, this)));
    }
            ...
            implements FunctionSimplifier
    {
        ...
        {
            if ((Tangent.this.parameter instanceof Constant))
            {
