        ...
        extends BinaryOperator
{
    ...
    static Function[] compressConstant(final Function[] array)
    {
        ...
        if ((!(array[0] instanceof Constant)) || (!(array[1] instanceof Constant)))
        {
            return array;
        }
        ...
        double value = array[0].obtainRealValueNumber() + array[1].obtainRealValueNumber();

        while ((index < length) && ((array[index] instanceof Constant)))
        {
     ...
     *
     * @param function Function where extract
     ...
     *
     * @param addition Addition where extract
    ...
    protected boolean functionIsEqualsMoreSimple(final Function function)
    {
        ...
        if (function instanceof Addition)
        {
            ...
            if (this.parameter1.functionIsEqualsMoreSimple(addition.parameter1))
            {
                return this.parameter2.functionIsEqualsMoreSimple(addition.parameter2);
            }

            if (this.parameter1.functionIsEqualsMoreSimple(addition.parameter2))
            {
    ...
    {
        return Function.createAddition(this.parameter1.replace(variable, function),
            ...
            implements FunctionSimplifier
    {
        ...
        private Function simplify(final Addition addition, final Function function)
        {
            ...
            return new Addition(addition.getParameter2()
                                        .simplify(), new Addition(addition.getParameter1()
        ...
        private Function simplify(final Function function, final MinusUnary minusUnary)
        {
            ...
            return new Subtraction(function.simplify(), minusUnary.getParameter()
                                                                  .simplify());
        }
         ...
         *
         * @param function       f1
         * @param multiplication f2 * f3
         * @return Simplified function
         */
        private Function simplify(final Function function, final Multiplication multiplication)
        {
            return this.simplifyAdditionOfMultiplicationAndFunction(multiplication.parameter1, multiplication.parameter2,
                                                                    function);
        }
         ...
         *
         * @param function    f1
         * @param subtraction f2 - f3
         * @return Simplified to (f2 + f1) - f3
         */
        private Function simplify(final Function function, final Subtraction subtraction)
        {
            if (subtraction.parameter2.equals(function))
            {
            ...
            return new Subtraction(Function.createAddition(subtraction.parameter1.simplify(), function.simplify()),
         ...
         * .
         *
         * @param logarithm1 ln(f1)
         * @param logarithm2 ln(f12)
         * @return Simplified to ln(f1 * f2)
         */
        private Function simplify(final Logarithm logarithm1, final Logarithm logarithm2)
        {
            ...
            return new Logarithm(Function.createMultiplication(logarithm1.getParameter()
                                                                         .simplify(), logarithm2.getParameter()
                                                                                                .simplify()));
        }
         ...
         * .
         *
         * @param minusUnary1 -f1
         * @param minusUnary2 -f2
         * @return - (f1 + f2)
         */
        private Function simplify(final MinusUnary minusUnary1, final MinusUnary minusUnary2)
        {
            ...
            return new MinusUnary(new Addition(minusUnary1.getParameter()
                                                          .simplify(), minusUnary2.getParameter()
                                                                                  .simplify()));
        }
         ...
         * .
         *
         * @param multiplication1 f1 * f2
         * @param multiplication2 f3 * f4
         * @return Simplified function
         */
        private Function simplify(final Multiplication multiplication1, final Multiplication multiplication2)
        {
            ...
            if ((function1 instanceof Cosinus))
            {
                if (((function2 instanceof Cosinus)) && ((function3 instanceof Sinus)) && ((function4
                                                                                                    instanceof Sinus)))
                {
                    return this.simplifyAdditionOfMultiplications((Cosinus) function1, (Cosinus) function2,
                                                                  (Sinus) function3, (Sinus) function4);
                }

                if (((function2 instanceof Sinus)) && ((function3 instanceof Cosinus)) && ((function4
                                                                                                    instanceof Sinus)))
                {
                    return this.simplifyAdditionOfMultiplications((Cosinus) function1, (Sinus) function2,
                                                                  (Cosinus) function3, (Sinus) function4);
                }

                if (((function2 instanceof Sinus)) && ((function3 instanceof Sinus)) && ((function4
                                                                                                  instanceof Cosinus)))
                {
                    return this.simplifyAdditionOfMultiplications((Cosinus) function1, (Sinus) function2,
                                                                  (Sinus) function3, (Cosinus) function4);
                }
            }

            if ((function1 instanceof Sinus))
            {
                if (((function2 instanceof Cosinus)) && ((function3 instanceof Sinus)) && ((function4
                                                                                                    instanceof Cosinus)))
                {
                    return this.simplifyAdditionOfMultiplications((Sinus) function1, (Cosinus) function2,
                                                                  (Sinus) function3, (Cosinus) function4);
                }

                if (((function2 instanceof Cosinus)) && ((function3 instanceof Cosinus)) && ((function4
                                                                                                      instanceof Sinus)))
                {
                    return this.simplifyAdditionOfMultiplications((Sinus) function1, (Cosinus) function2,
                                                                  (Cosinus) function3, (Sinus) function4);
                ...
                if (((function2 instanceof Sinus)) && ((function3 instanceof Cosinus)) && ((function4
                                                                                                    instanceof Cosinus)))
                {
                    return this.simplifyAdditionOfMultiplications((Sinus) function1, (Sinus) function2,
                                                                  (Cosinus) function3, (Cosinus) function4);
                }
            }
            ...
            return this.simplifyAdditionOfMultiplications(function1, function2, function3, function4);
        }
        ...
        {
            return Function.createAddition(function2, new Division(Function.createMultiplication(percent1.parameter,
                                                                                                 function2),
                                                                   Constant.HUNDRED));
        }
         ...
         * @param percent1 p1
         * @param percent2 p2
         * @return Simplified to (p1 + p2 + (p1*p2)/100)%
         */
        private Function simplify(final Percent percent1, final Percent percent2)
        {
            return new Percent(Function.createAddition(percent1.parameter, percent2.parameter, new Division(
                    Function.createMultiplication(percent1.parameter, percent2.parameter), Constant.HUNDRED)));
        }
         ...
         * .
         *
         * @param subtraction f1 - f2
         * @param function    f3
         * @return Simplified to (f3 - f2) + f1
         */
        private Function simplify(final Subtraction subtraction, final Function function)
        {
            ...
            return new Subtraction(Function.createAddition(function.simplify(), subtraction.parameter1.simplify()),
                                   subtraction.parameter2.simplify());
        }
         ...
         * .
         *
         * @param subtraction1 f1 - f2
         * @param subtraction2 f3 - f4
         * @return Simplified to (f1 + f3) - (f2 + f4)
         */
        private Function simplify(final Subtraction subtraction1, final Subtraction subtraction2)
        {
            ...
            return new Subtraction(
                    Function.createAddition(subtraction1.parameter1.simplify(), subtraction2.parameter1.simplify())
                            .simplify(), Function.createAddition(subtraction1.parameter2.simplify(),
                                                                 subtraction2.parameter2.simplify())
                                                 .simplify());
        }
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplications(final Cosinus cosinus1, final Cosinus cosinus2, final Sinus
                sinus1, final Sinus sinus2)
        {
            ...
            return Function.createAddition(Function.createMultiplication(sinus2.simplify(), sinus1.simplify()),
                                           Function.createMultiplication(cosinus2.simplify(), cosinus1.simplify()));
        }
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplications(final Cosinus cosinus1, final Sinus sinus1, final Cosinus
                cosinus2, final Sinus sinus2)
        {
            ...
            return Function.createAddition(
                    Function.createMultiplication(sinus2.parameter.simplify(), cosinus2.parameter.simplify()),
                    Function.createMultiplication(sinus1.parameter.simplify(), cosinus1.parameter.simplify()));
        }
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplications(final Cosinus cosinus1, final Sinus sinus1, final Sinus sinus2,
                                                           final Cosinus cosinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter)) && (sinus1.parameter.equals(cosinus2.parameter)))
            {
                return new Sinus(Function.createAddition(cosinus1.parameter.simplify(), sinus1.parameter.simplify()));
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplications(final Function function1, final Function function2, final
        Function function3, final Function function4)
        {
            if (function1.equals(function3))
            {
                return Function.createMultiplication(Function.createAddition(function2.simplify(), function4.simplify()),
                                                     function1.simplify());
            }

            if (function1.equals(function4))
            {
                return Function.createMultiplication(Function.createAddition(function2.simplify(), function3.simplify()),
                                                     function1.simplify());
            }

            if (function2.equals(function3))
            {
                return Function.createMultiplication(Function.createAddition(function1.simplify(), function4.simplify()),
                                                     function2.simplify());
            }

            if (function2.equals(function4))
            {
                return Function.createMultiplication(Function.createAddition(function1.simplify(), function3.simplify()),
                                                     function2.simplify());
            }
            ...
            return Function.createAddition(Function.createMultiplication(function4.simplify(), function3.simplify()),
                                           Function.createMultiplication(function2.simplify(), function1.simplify()));
        }
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplications(final Sinus sinus1, final Cosinus cosinus1, final Cosinus
                cosinus2, final Sinus sinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter)) && (sinus1.parameter.equals(cosinus2.parameter)))
            {
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplications(final Sinus sinus1, final Cosinus cosinus1, final Sinus sinus2,
                                                           final Cosinus cosinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter)) && (sinus1.parameter.equals(cosinus2.parameter)))
            {
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplications(final Sinus sinus1, final Sinus sinus2, final Cosinus cosinus1,
                                                           final Cosinus cosinus2)
        {
            if (((cosinus1.parameter.equals(sinus1.parameter)) && (cosinus2.parameter.equals(sinus2.parameter)))
                    || ((cosinus1.parameter.equals(sinus2.parameter)) && (cosinus2.parameter.equals(sinus1.parameter))))
         ...
         * @return Simplified function
         */
        private Function simplifyAdditionOfMultiplicationAndFunction(final Function parameter1, final Function parameter2,
                                                                     final Function function)
        {
            if (parameter1.equals(function))
            {
                return Function.createMultiplication(Function.createAddition(Constant.ONE, parameter2.simplify()),
                                                     function.simplify());
            }

            if (parameter2.equals(function))
            {
                return Function.createMultiplication(Function.createAddition(Constant.ONE, parameter1.simplify()),
                                                     function.simplify());
            }
            ...
            return Function.createAddition(function.simplify(),
                                           Function.createMultiplication(parameter1.simplify(), parameter2.simplify()));
        }
        ...
        public Function simplify()
        {
            ...
            if (((function1 instanceof Logarithm)) && ((function2 instanceof Logarithm)))
            {
