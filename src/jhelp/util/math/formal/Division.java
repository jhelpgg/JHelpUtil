        ...
        extends BinaryOperator
{
    ...
    protected boolean functionIsEqualsMoreSimple(final Function function)
    {
        ...
        if (function instanceof Division)
        {
            ...
            if (this.parameter1.functionIsEqualsMoreSimple(division.parameter1))
            {
    ...
    public boolean functionIsEquals(final Function function)
    {
        ...
        {
            final Division division = (Division) function;
            return this.parameter1.functionIsEquals(division.parameter1) && this.parameter2.functionIsEquals(
                    division.parameter2);
        }
        else
        {
    ...
    public Function derive(final Variable variable)
    {
        ...
        return new Division(new Subtraction(Function.createMultiplication(d1, this.parameter2),
                                            Function.createMultiplication(this.parameter1, d2)),
                            Function.createMultiplication(this.parameter2, this.parameter2));
    }
            ...
            implements FunctionSimplifier
    {
        ...
        public Function simplify()
        {
            ...
            if ((numerator instanceof MinusUnary))
            {
                if ((denominator instanceof MinusUnary))
                {
            ...
            if ((numerator instanceof Percent))
            {
                if ((denominator instanceof Percent))
                {
            ...
            if ((numerator instanceof Constant))
            {
                ...
                if ((denominator instanceof Multiplication))
                {
            ...
            if ((numerator instanceof Multiplication) && (denominator instanceof Constant))
            {
            ...
            if (((numerator instanceof Cosinus)) && ((denominator instanceof Sinus)))
            {
                return this.simplify((Cosinus) numerator, (Sinus) denominator);
            }

            if ((numerator instanceof Division))
            {
            ...
            if (((numerator instanceof Exponential)) && ((denominator instanceof Exponential)))
            {
                return this.simplify((Exponential) numerator, (Exponential) denominator);
            }

            if (((numerator instanceof Sinus)) && ((denominator instanceof Cosinus)))
            {
         ...
         * Simplify C1/C2 -> C3
         *
         * @param constant1 Constant C1
         * @param constant2 Constant C2
         * @return Constant result C3
         */
        private Function simplify(final Constant constant1, final Constant constant2)
        {
            if ((constant1.isUndefined()) || (constant2.isUndefined()) || (constant2.isNul()))
            {
         ...
         * </ul>
         *
         * @param constant       Constant C1
         * @param multiplication Multiplication (C2*f, f*C2 or f1*f2)
         * @return Simplified function
         */
         ...
         *
         * @param constant          C1
         * @param parameterConstant C2
         * @param parameter         f
         * @return C3/f
         */
        private Function simplifyDivisionOfConstantMultiplication(final Constant constant, final Constant
                parameterConstant, final Function parameter)
        {
            if ((parameterConstant.isUndefined()) || (parameterConstant.isNul()) || (constant.isUndefined()))
            {
                return Constant.UNDEFINED;
            }

            return new Division(new Constant(constant.obtainRealValueNumber() / parameterConstant.obtainRealValueNumber()),
                                parameter.simplify());
        }
         ...
         * @return C3/f
         */
        private Function simplifyDivisionOfConstantMultiplication(final Constant constant, final Function parameter, final
         ...
         * @return Simplified function
         */
        private Function simplifyDivisionOfConstantMultiplication(final Constant constant, final Function parameter1,
                                                                  final Function parameter2)
        {
         ...
         *
         * @param cosinus Cosinus function
         * @param sinus   Sinus function
         * @return Simplified function
         */
        private Function simplify(final Cosinus cosinus, final Sinus sinus)
        {
            if (cosinus.parameter.equals(sinus.parameter))
            {
         ...
         *
         * @param division1 First division f1/f2
         * @param division2 Second division f3/f4
         * @return Result (f1*f4)/(f2*f3)
         */
        private Function simplify(final Division division1, final Division division2)
        {
            return new Division(
                    Function.createMultiplication(division1.parameter1.simplify(), division2.parameter2.simplify()),
                    Function.createMultiplication(division1.parameter2.simplify(), division2.parameter1.simplify()));
        }

        /**
         * Simplify (f1/f2)/f3 -> f1/(f2*f3)
         *
         * @param division Division f1/f2
         * @param function Function f3
         * @return Result f1/(f2*f3)
         */
        private Function simplify(final Division division, final Function function)
        {
            return new Division(division.parameter1.simplify(),
                                Function.createMultiplication(division.parameter2.simplify(), function.simplify()));
        }

        /**
         * Simplify e<sup>f1</sup>/e<sup>f2</sup> -> e<sup>f1-f2</sup>
         *
         * @param exponential1 First exponential e<sup>f1</sup>
         * @param exponential2 Second exponential e<sup>f2</sup>
        ...
        {
            if ((constant.isUndefined()) || (constant.isNul()))
            {
                return Constant.UNDEFINED;
            }
            ...
            if (constant.isMinusOne())
            {
                return new MinusUnary(function.simplify());
            }

            return Function.createMultiplication(new Constant(1.0 / constant.obtainRealValueNumber()),
                                                 function.simplify());
        }
         ...
         *
         * @param function f1
         * @param division f2/f3
         * @return (f1*f3)/f2
         */
        private Function simplify(final Function function, final Division division)
        {
            return new Division(Function.createMultiplication(function.simplify(), division.parameter2.simplify()),
                                division.parameter1.simplify());
        }
         ...
         *
         * @param function1 Function X argument
         * @param percent2  Percent P argument
         ...
         * (-f1)/-(f2) -> f1/f2
         *
         * @param minusUnaryNumerator   -f1
         * @param minusUnaryDenominator -f2
         * @return f1/f2
         */
         ...
         * (C1*f)/C2 -> C3*f
         *
         * @param parameterConstant C1
         * @param parameter         f
         * @param constant          C2
         * @return C3*f
         */
        private Function simplifyDivisionOfMultiplicationConstant(final Constant parameterConstant, final Function
                parameter, final Constant constant)
        {
            if ((parameterConstant.isUndefined()) || (constant.isUndefined()) || (constant.isNul()))
            {
                return Constant.UNDEFINED;
            }

            return new Multiplication(
                    new Constant(parameterConstant.obtainRealValueNumber() / constant.obtainRealValueNumber()), parameter);
        }
         ...
         * @return C3*f
         */
        private Function simplifyDivisionOfMultiplicationConstant(final Function parameter, final Constant
                parameterConstant, final Constant constant)
        {
            if ((parameterConstant.isUndefined()) || (constant.isUndefined()) || (constant.isNul()))
            {
                return Constant.UNDEFINED;
            ...
            return new Multiplication(
                    new Constant(parameterConstant.obtainRealValueNumber() / constant.obtainRealValueNumber()),
                    parameter.simplify());
        }
         ...
         * @return simplified function
         */
        private Function simplifyDivisionOfMultiplicationConstant(final Function parameter1, final Function parameter2,
         ...
         *
         * @param percent1  Percent P argument
         * @param function2 Function X argument
         * @return Simplification
         */
        ...
        {
            if (sinus.parameter.equals(cosinus.parameter))
            {
