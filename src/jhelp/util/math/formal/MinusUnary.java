        ...
        extends UnaryOperator
{
            ...
            implements FunctionSimplifier
    {
         ...
         * </table>
         *
         * @param division Division argument
         * @return Simplification
         */
         ...
         * Simplification : -(-X) -> X
         *
         * @param minusUnary Minus unary argument
         * @return Simplification
         */
         ...
         * </table>
         *
         * @param multiplication Multiplication to simplify
         * @return Simplification
         */
         ...
         *
         * @param function Function argument C
         * @param constant Constant argument C1
         * @return Simplification
         */
         ...
         *
         * @param subtraction Subtraction argument
         * @return Simplification
         */
