        ...
        extends BinaryOperator
{
    ...
    protected boolean functionIsEqualsMoreSimple(final Function function)
    {
        ...
        if (function instanceof Subtraction)
        {
            ...
            if (this.parameter1.functionIsEqualsMoreSimple(subtraction.parameter1))
            {
    ...
    public boolean functionIsEquals(final Function function)
    {
        ...
        if (function instanceof Subtraction)
        {
            ...
            {
                if (this.parameter2.functionIsEquals(subtraction.parameter2))
                {
                    return true;
                }
            }
            ...
            implements FunctionSimplifier
    {
        ...
        public Function simplify()
        {
            ...
            if ((function1 instanceof MinusUnary))
            {
                if ((function2 instanceof MinusUnary))
                {
            ...
            if ((function1 instanceof Percent))
            {
                if ((function2 instanceof Percent))
                {
            ...
            {
                if ((function2 instanceof Constant))
                {
            ...
            if ((function1 instanceof Subtraction))
            {
                if ((function2 instanceof Subtraction))
                {
            ...
            if ((function1 instanceof Multiplication))
            {
                if ((function2 instanceof Multiplication))
                {
            ...
            if ((function1 instanceof Logarithm))
            {
                if ((function2 instanceof Logarithm))
                {
         ...
         *
         * @param constant1 Constant argument C1
         * @param constant2 Constant Argument C2
         * @return Simplification
         */
        private Function simplify(final Constant constant1, final Constant constant2)
        {
            if ((constant1.isUndefined()) || (constant2.isUndefined()))
            {
         ...
         * </table>
         *
         * @param function1 First function argument
         * @param function2 Second function argument
         * @return Simplification
         */
        private Function simplify(final Function function1, final Function function2)
        {
            ...
            if ((additions1.length > 1) || (additions2.length > 1))
            {
                ...
                for (int i = 1; i < o; i++)
                {
                    f = Function.createAddition(f.simplify(),
                                                new Subtraction(additions1[i].simplify(), additions2[i].simplify()));
                }
                ...
                if (n > m)
                {
                    return Function.createAddition(f.simplify(),
                                                   Function.createAddition(Arrays.copyOfRange(additions1, o, n))
                                                           .simplify());
                }

                return new Subtraction(f.simplify(), Function.createAddition(Arrays.copyOfRange(additions2, o, m))
                                                             .simplify());
            }
            ...
            if ((function1 instanceof Addition))
            {
                return this.simplify((Addition) function1, function2);
            }

            if ((function2 instanceof Addition))
            {
         ...
         * </table>
         *
         * @param addition Addition argument
         * @param function Function argument
         * @return Simplification
         */
        private Function simplify(final Addition addition, final Function function)
        {
            if (addition.parameter1.equals(function))
            {
                return addition.parameter2.simplify();
            }

            if (addition.parameter2.equals(function))
            {
                return addition.parameter1.simplify();
            }

            return Function.createAddition(new Subtraction(addition.parameter1.simplify(), function.simplify()),
                                           addition.parameter2.simplify());
        }
        ...
        private Function simplify(final Function function, final Addition addition)
        {
            ...
            return new Subtraction(new Subtraction(function.simplify(), addition.parameter1.simplify()),
                                   addition.parameter2.simplify());
        }
         ...
         *
         * @param function   Function argument X
         * @param minusUnary Minus unary argument -Y
         * @return Simplification
         */
         ...
         *
         * @param function       Function argument X
         * @param multiplication Multiplication argument
         * @return Simplification
         */
        private Function simplify(final Function function, final Multiplication multiplication)
        {
            if ((function.equals(multiplication.parameter1)) && ((multiplication.parameter2 instanceof Constant)))
            {
                final Constant constant = (Constant) multiplication.parameter2;

                return Function.createMultiplication(new Constant(1 - constant.obtainRealValueNumber()),
                                                     function.simplify());
            }

            if ((function.equals(multiplication.parameter2)) && ((multiplication.parameter1 instanceof Constant)))
            {
         ...
         *
         * @param function1 Function argument X
         * @param percent2  Percent argument P
         * @return Simplification
         */
        private Function simplify(final Function function1, final Percent percent2)
        {
            return new Subtraction(function1, new Division(Function.createMultiplication(percent2.parameter, function1),
                                                           Constant.HUNDRED));
        }
         ...
         *
         * @param function    Function argument X
         * @param subtraction Subtraction argument Y-Z
         * @return Simplification
         */
        private Function simplify(final Function function, final Subtraction subtraction)
        {
            return Function.createAddition(function.simplify(), new Subtraction(subtraction.parameter2.simplify(),
                                                                                subtraction.parameter1.simplify()));
        }

        /**
         * Simplification : ln(X)-ln(Y) -> ln(X/Y)
         *
         * @param logarithm1 Logarithm argument ln(X)
         * @param logarithm2 Logarithm argument ln(Y)
         * @return Simplification
         */
         ...
         * @param function   Function argument Y
         * @return Simplification
         */
         ...
         *
         * @param minusUnary1 Minus unary argument -X
         * @param minusUnary2 Minus unary argument -Y
         * @return Simplification
         */
        ...
        private Function simplify(final Multiplication multiplication, final Function function)
        {
            if ((function.equals(multiplication.parameter1)) && ((multiplication.parameter2 instanceof Constant)))
            {
                ...
                return Function.createMultiplication(new Constant(constant.obtainRealValueNumber() - 1),
                                                     function.simplify());
            }
         ...
         * </table>
         *
         * @param multiplication1 First multiplication argument
         * @param multiplication2 Second Multiplication argument
         * @return Simplification
         */
        private Function simplify(final Multiplication multiplication1, final Multiplication multiplication2)
        {
            if ((multiplication1.parameter1 instanceof Constant))
            {
                if ((multiplication2.parameter1 instanceof Constant))
                {
                    return this.simplifySubtractionOfMultiplications((Constant) multiplication1.parameter1,
                                                                     multiplication1.parameter2, (Constant)
                                                                             multiplication2.parameter1,
                                                                     multiplication2.parameter2);
                }

                if ((multiplication2.parameter2 instanceof Constant))
                {
                    return this.simplifySubtractionOfMultiplications((Constant) multiplication1.parameter1,
                                                                     multiplication1.parameter2,
                                                                     multiplication2.parameter1,
                                                                     (Constant) multiplication2.parameter2);
                }

                if (multiplication1.parameter2.equals(multiplication2))
                {
                    return Function.createMultiplication(
                            new Constant(multiplication1.parameter1.obtainRealValueNumber() - 1),
                            multiplication2.parameter1.simplify(), multiplication2.parameter2.simplify());
                }
            }

            if ((multiplication1.parameter2 instanceof Constant))
            {
                if ((multiplication2.parameter1 instanceof Constant))
                {
                    return this.simplifySubtractionOfMultiplications(multiplication1.parameter1,
                                                                     (Constant) multiplication1.parameter2,
                                                                     (Constant) multiplication2.parameter1,
                                                                     multiplication2.parameter2);
                }
                ...
                if (multiplication1.parameter1.equals(multiplication2))
                {
                    return Function.createMultiplication(
                            new Constant(multiplication1.parameter2.obtainRealValueNumber() - 1),
                            multiplication2.parameter1.simplify(), multiplication2.parameter2.simplify());
                }
            }
            ...
            if ((multiplication2.parameter1 instanceof Constant))
            {
                if (multiplication2.parameter2.equals(multiplication1))
                {
                    return Function.createMultiplication(
                            new Constant(1 - multiplication2.parameter1.obtainRealValueNumber()),
                            multiplication1.parameter1.simplify(), multiplication1.parameter2.simplify());
                }
            }

            if ((multiplication2.parameter2 instanceof Constant))
            {
                if (multiplication2.parameter1.equals(multiplication1))
                {
                    return Function.createMultiplication(
                            new Constant(1 - multiplication2.parameter2.obtainRealValueNumber()),
                            multiplication1.parameter1.simplify(), multiplication1.parameter2.simplify());
                }
            }

            if ((multiplication1.parameter1 instanceof Cosinus))
            {
                if (((multiplication1.parameter2 instanceof Cosinus)) && ((multiplication2.parameter1 instanceof Sinus))
                        && ((multiplication2.parameter2 instanceof Sinus)))
                {
                    return this.simplifySubtractionOfMultiplications((Cosinus) multiplication1.parameter1,
                                                                     (Cosinus) multiplication1.parameter2,
                                                                     (Sinus) multiplication2.parameter1,
                                                                     (Sinus) multiplication2.parameter2);
                }

                if (((multiplication1.parameter2 instanceof Sinus)) && ((multiplication2.parameter1 instanceof Cosinus))
                        && ((multiplication2.parameter2 instanceof Sinus)))
                {
                    return this.simplifySubtractionOfMultiplications((Cosinus) multiplication1.parameter1,
                                                                     (Sinus) multiplication1.parameter2,
                                                                     (Cosinus) multiplication2.parameter1,
                                                                     (Sinus) multiplication2.parameter2);
                }

                if (((multiplication1.parameter2 instanceof Sinus)) && ((multiplication2.parameter1 instanceof Sinus))
                        && ((multiplication2.parameter2 instanceof Cosinus)))
                {
                    return this.simplifySubtractionOfMultiplications((Cosinus) multiplication1.parameter1,
                                                                     (Sinus) multiplication1.parameter2,
                                                                     (Sinus) multiplication2.parameter1,
                                                                     (Cosinus) multiplication2.parameter2);
                }
            }

            if ((multiplication1.parameter1 instanceof Sinus))
            {
                if (((multiplication1.parameter2 instanceof Cosinus)) && ((multiplication2.parameter1 instanceof
                                                                                   Cosinus)) && (
                                                                                           (multiplication2.parameter2
                                                                                                    instanceof Sinus)))
                {
                    return this.simplifySubtractionOfMultiplications((Sinus) multiplication1.parameter1,
                                                                     (Cosinus) multiplication1.parameter2,
                                                                     (Cosinus) multiplication2.parameter1,
                                                                     (Sinus) multiplication2.parameter2);
                }
            ...
            return this.simplifySubtractionOfMultiplications(multiplication1.parameter1, multiplication1.parameter2,
                                                             multiplication2.parameter1, multiplication2.parameter2);
        }

        /**
         * Simplification : (X1 * ... * Xn * C1 * Y1 * ... * Ym) - (X1 * ... * Xn * C2 * Y1 * ... * Ym) -> C3 * X1 * ... *
         * Xn * Y1
         * * ... * Ym
         *
         * @param function1 First function argument
            ...
            if ((multiplications1.length > 1) || (multiplications2.length > 1))
            {
                ...
                if ((multiplications1.length > 1) || (multiplications2.length > 1))
                {
                    ...
                    if (multiplications1[0] instanceof Constant)
                    {
                        ...
                        f1 = Function.createMultiplication(
                                Arrays.copyOfRange(multiplications1, 1, multiplications1.length));
                    }
                    else
                    {
                        value = 1;
                    ...
                    if (multiplications2[0] instanceof Constant)
                    {
                        ...
                        f2 = Function.createMultiplication(
                                Arrays.copyOfRange(multiplications2, 1, multiplications2.length));
                    }
                    else
                    {
                        value -= 1;
         ...
         * @param function1 Function argument X
         * @param constant2 Constant argument C2
         * @param function2 Function argument X or Y
         * @return Simplification
         */
        private Function simplifySubtractionOfMultiplications(final Constant constant1, final Function function1, final
        Constant constant2, final Function function2)
        {
            if ((constant1.isUndefined()) || (constant2.isUndefined()))
            {
                return Constant.UNDEFINED;
            ...
            if (function1.equals(function2))
            {
                return new Multiplication(
                        new Constant(constant1.obtainRealValueNumber() - constant2.obtainRealValueNumber()
                        ), function1.simplify());
            }
            ...
            return Function.createAddition(
                    new Multiplication(new Constant(-constant2.obtainRealValueNumber()), function2.simplify()),
                    new Multiplication(constant1, function1.simplify()));
        }
         ...
         */
        private Function simplifySubtractionOfMultiplications(final Constant constant1, final Function function1, final
        Function function2, final Constant constant2)
        {
            if ((constant1.isUndefined()) || (constant2.isUndefined()))
            {
                return Constant.UNDEFINED;
         ...
         * @return cos(f1+f2)
         */
        private Function simplifySubtractionOfMultiplications(final Cosinus cosinus1, final Cosinus cosinus2,
                                                              final Sinus sinus1, final Sinus sinus2)
        {
            if (((cosinus1.parameter.equals(sinus1.parameter)) && (cosinus2.parameter.equals(sinus2.parameter)))
                    || ((cosinus1.parameter.equals(sinus2.parameter)) && (cosinus2.parameter.equals(sinus1.parameter))))
            {
                return new Cosinus(Function.createAddition(cosinus1.parameter.simplify(), cosinus2.parameter.simplify()));
            }

            return new Subtraction(Function.createMultiplication(cosinus1.simplify(), cosinus2.simplify()),
                                   Function.createMultiplication(sinus1.simplify(), sinus2.simplify()));
        }
         ...
         * @return sin(f1-f2)
         */
        private Function simplifySubtractionOfMultiplications(final Cosinus cosinus1, final Sinus sinus1,
                                                              final Cosinus cosinus2, final Sinus sinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter)) && (sinus1.parameter.equals(cosinus2.parameter)))
            {
                return new Sinus(new Subtraction(sinus1.parameter.simplify(), cosinus1.parameter.simplify()));
            }

            return new Subtraction(Function.createMultiplication(cosinus1.simplify(), cosinus2.simplify()), Function
                    .createMultiplication(sinus1.simplify(), sinus2.simplify()));
        }
         ...
         */
        private Function simplifySubtractionOfMultiplications(final Cosinus cosinus1, final Sinus sinus1,
                                                              final Sinus sinus2, final Cosinus cosinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter)) && (sinus1.parameter.equals(cosinus2.parameter)))
            {
                return new Sinus(new Subtraction(sinus1.parameter.simplify(), cosinus1.parameter.simplify()));
         ...
         * @return Simplification
         */
        private Function simplifySubtractionOfMultiplications(final Function function1, final Constant constant1, final
        Constant constant2, final Function function2)
        {
            if ((constant1.isUndefined()) || (constant2.isUndefined()))
            {
         ...
         * @return (f1*f2)-(f3*f4)
         */
        private Function simplifySubtractionOfMultiplications(final Function function1, final Function function2,
                                                              final Function function3, final Function function4)
        {
            return new Subtraction(Function.createMultiplication(function1.simplify(), function2.simplify()),
                                   Function.createMultiplication(function3.simplify(), function4.simplify()));
        }
         ...
         * @param cosinus2 cos(f1)
         * @param sinus2   sin(f2)
         * @return sin(f1-f2)
         */
        private Function simplifySubtractionOfMultiplications(final Sinus sinus1, final Cosinus cosinus1,
                                                              final Cosinus cosinus2, final Sinus sinus2)
        {
            if ((cosinus1.parameter.equals(sinus2.parameter)) && (sinus1.parameter.equals(cosinus2.parameter)))
            {
         ...
         * @return -cos(f1+f2)
         */
        private Function simplifySubtractionOfMultiplications(final Sinus sinus1, final Sinus sinus2,
                                                              final Cosinus cosinus1, final Cosinus cosinus2)
        {
            if (((cosinus1.parameter.equals(sinus1.parameter)) && (cosinus2.parameter.equals(sinus2.parameter)))
                    || ((cosinus1.parameter.equals(sinus2.parameter)) && (cosinus2.parameter.equals(sinus1.parameter))))
            {
                return new MinusUnary(new Cosinus(Function.createAddition(cosinus1.parameter.simplify(), cosinus2.parameter
                        .simplify())));
            }
         ...
         *
         * @param percent1  Percent argument P
         * @param function2 Function argument X
         * @return Simplification
         */
        private Function simplify(final Percent percent1, final Function function2)
        {
            return Function.createAddition(new MinusUnary(function2), new Division(
                    Function.createMultiplication(percent1.parameter, new MinusUnary(function2)), Constant.HUNDRED));
        }

        /**
         * Simplification : P1% - P2% -> (P1-(P2+((P1*P2)/100)))%
         *
         * @param percent1 Percent P1 argument
         * @param percent2 Percent P2 argument
         * @return Simplification
         */
        private Function simplify(final Percent percent1, final Percent percent2)
        {
            return new Percent(new Subtraction(percent1.parameter, new Addition(percent2.parameter, new Division(
                    new Multiplication(percent1.parameter, percent2.parameter), Constant.HUNDRED))));
        }

        /**
         * Simplification : (X-Y)-Z -> (X-Z)-Y
         *
         * @param subtraction Subtraction argument X-Y
         * @param function    Function argument Z
         * @return Simplification
         */
        private Function simplify(final Subtraction subtraction, final Function function)
        {
            return new Subtraction(new Subtraction(subtraction.parameter1.simplify(), function.simplify()),
                                   subtraction.parameter2.simplify());
        }

        /**
         * Simplification : (X-Y)-(Z-A) -> (X-Z)+(A-Y)
         *
         * @param subtraction1 Subtraction argument X-Y
         * @param subtraction2 Subtraction argument Z-A
         * @return Simplification
         */
        private Function simplify(final Subtraction subtraction1, final Subtraction subtraction2)
        {
            return Function.createAddition(
                    new Subtraction(subtraction1.parameter1.simplify(), subtraction2.parameter1.simplify()),
                    new Subtraction(subtraction2.parameter2.simplify(), subtraction1.parameter2.simplify()));
        }
    }
}