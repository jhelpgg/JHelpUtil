        ...
        extends BinaryOperator
{
     ...
     *
     * @param function Function where extract parameters
     ...
     *
     * @param multiplication Multiplication where extract
    ...
    protected boolean functionIsEqualsMoreSimple(final Function function)
    {
        ...
        if (function instanceof Multiplication)
        {
            ...
            if (this.parameter1.functionIsEqualsMoreSimple(multiplication.parameter1))
            {
                return this.parameter2.functionIsEqualsMoreSimple(multiplication.parameter2);
            }

            if (this.parameter1.functionIsEqualsMoreSimple(multiplication.parameter2))
            {
    ...
    public Function derive(final Variable variable)
    {
        ...
        return Function.createAddition(Function.createMultiplication(d1, this.parameter2), Function.createMultiplication
                (this.parameter1, d2));
    }
    ...
    {
        return Function.createMultiplication(this.parameter1.replace(variable, function), this.parameter2.replace
                (variable, function));
    }
            ...
            implements FunctionSimplifier
    {
        ...
        public Function simplify()
        {
            ...
            if ((function1 instanceof Division))
            {
                if ((function2 instanceof Division))
                {
            ...
            if (((function1 instanceof Exponential)) && ((function2 instanceof Exponential)))
            {
        ...
        private Function simplify(final Constant constant, final Multiplication multiplication)
        {
            ...
            if ((multiplication.parameter1 instanceof Constant))
            {
                final Constant constant2 = (Constant) multiplication.parameter1;

                if (constant2.isUndefined())
                {
                    return Constant.UNDEFINED;
                }
                ...
                return new Multiplication(
                        new Constant(constant.obtainRealValueNumber() * constant2.obtainRealValueNumber()),
                        multiplication.parameter2.simplify());
            }

            if ((multiplication.parameter2 instanceof Constant))
            {
                ...
                return new Multiplication(
                        new Constant(constant.obtainRealValueNumber() * constant2.obtainRealValueNumber()),
                        multiplication.parameter1.simplify());
            }
         ...
         *
         * @param division1 Division argument X/Y
         * @param division2 Division argument Z/A
         * @return Simplification
         */
        private Function simplify(final Division division1, final Division division2)
        {
            return new Division(
                    Function.createMultiplication(division1.parameter1.simplify(), division2.parameter1.simplify()),
                    Function.createMultiplication(division1.parameter2.simplify(), division2.parameter2.simplify()));
        }

        /**
         * Simplification : (X/Y)*Z -> (X*Z)/Y
         *
         * @param division Division argument X/Y
         * @param function Function argument Z
         * @return Simplification
         */
        private Function simplify(final Division division, final Function function)
        {
            return new Division(Function.createMultiplication(division.parameter1.simplify(), function.simplify()),
                                division.parameter2.simplify());
        }

        /**
         * Simplification : exp(X)*exp(Y) -> exp(X+Y)
         *
         * @param exponential1 Exponential argument exp(X)
         * @param exponential2 Exponential argument exp(Y)
         * @return Simplification
         */
        private Function simplify(final Exponential exponential1, final Exponential exponential2)
        {
            return new Exponential(
                    Function.createAddition(exponential2.parameter.simplify(), exponential1.parameter.simplify()));
        }
         ...
         *
         * @param function function argument X
         * @param division Division argument Y/Z
         * @return Simplification
         */
        private Function simplify(final Function function, final Division division)
        {
            return new Division(Function.createMultiplication(function.simplify(), division.parameter1.simplify()),
                                division.parameter2.simplify());
        }
         ...
         * @param function2 Function argument Y
         * @return Simplification
         */
        ...
        {
            return new Division(new Multiplication(function1, percent2.parameter), Constant.HUNDRED);
        }

        /**
         * Simplification : (-X)*Y -> -(X*Y)
         *
         * @param minusUnary Minus argument -X
        ...
        {
            return new Division(new Multiplication(function2, percent1.parameter), Constant.HUNDRED);
        }

        /**
         * Simplification (P1%)*(P2%) -> ((P1*P2)/100)%
         *
         * @param percent1 Percent argument P1
         * @param percent2 Percent argument P2
         * @return Simplification
         */
        private Function simplify(final Percent percent1, final Percent percent2)
        {
            return new Percent(new Division(new Multiplication(percent1.parameter, percent2.parameter), Constant.HUNDRED));
        }
    }
}