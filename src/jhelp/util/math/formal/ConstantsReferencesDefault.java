        ...
        implements ConstantsReferences
{
     ...
     */
    public static ConstantsReferences getCurrentReferentialConstants()
    {
     ...
     *
     * @param constant Symbol
     * @return Function representation
     * @see jhelp.util.math.formal.ConstantsReferences#constantFunction(java.lang.String)
     */
    @Override
     ...
     * @see jhelp.util.math.formal.ConstantsReferences#defineConstant(java.lang.String, double)
     */
    @Override
    public void defineConstant(final String name, final double value)
    {
        this.table.put(name, new Double(value));
    }

    /**
     * Indicate if constants is define
     *
     * @param constant Symbol tested
     * @return {@code true} if constants is definee
     * @see jhelp.util.math.formal.ConstantsReferences#isConstantDefine(java.lang.String)
     */
    @Override
     ...
     * Constant value
     *
     * @param constant Symbol search
     * @return Constant value
     * @see jhelp.util.math.formal.ConstantsReferences#obtainConstantValue(java.lang.String)
     */
    @Override
