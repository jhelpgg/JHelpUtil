        ...
        implements Comparable<Function>
{
     ...
     */
    protected static ConstantsReferences references = ConstantsReferencesDefault.getCurrentReferentialConstants();
    /**
    ...
    private static String addParentheses(final String string)
    {
        ...
        // Add parentheses
        final StringBuilder sb = new StringBuilder(nb + 2);
        if (min == 0)
        {
            min = -1;
        }
     ...
     */
    public static boolean allEquals(final Function function, final Function... functions)
    {
        if (function == null)
        {
    ...
    public final boolean equals(final Object object)
    {
        ...
        if (object instanceof Function)
        {
            ...
            if (this.functionIsEqualsMoreSimple(f))
            {
                return true;
            }
    ...
    public static Function createMultiplication(final Function... functions)
    {
        ...
        switch (length)
        {
            ...
            case 4:
                return new Multiplication(new Multiplication(functions[0], functions[1]),
                                          new Multiplication(functions[2], functions[3]));
        }
    ...
    public static Function createMultiplication(final Function function, final int time)
    {
        ...
        switch (time)
        {
            ...
            default:
                ...
                return new Multiplication(Function.createMultiplication(function, midle),
                                          Function.createMultiplication(function, time - midle));
        }
    }
     ...
     *
     * @param function Function to power
    ...
    public static Function parse(String function)
    {
        ...
        final UnaryOperator unairy = UnaryOperator.parseUnaryOperator(function);
        if (unairy != null)
        {
            return unairy;
        }
     ...
     *
     * @param references New reference
     */
    ...
    public int compareTo(final Function function)
    {
        ...
        if ((this instanceof MinusUnary))
        {
            if (((function instanceof Constant)) || ((function instanceof Variable)))
            {
                return 1;
            }
            else
        ...
        if (((function instanceof Constant)) || ((function instanceof Variable)) || ((function instanceof
                                                                                              MinusUnary)))
        {
            return 1;
        }
