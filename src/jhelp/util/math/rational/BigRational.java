        ...
        implements Comparable<BigRational>
{
    ...
    public static BigRational middle(final BigRational rational1, final BigRational rational2)
    {
        ...
        return BigRational.createRational(rational1.numerator.multiply(rational2.denominator)
                                                             .add(rational2.numerator.multiply(rational1.denominator)),
                                          rational1.denominator.multiply(
                                                  rational2.denominator.multiply(UtilMath.BIG_TWO)));
    }
    ...
    public static BigRational parse(String string)
    {
        ...
        if (BigRational.INVALID_RATIONAL.equals(string))
        {
            return BigRational.INVALID;
        }
        ...
        try
        {
            return BigRational.createRational(new BigInteger(string.substring(0, index)
                                                                   .trim()), new BigInteger(string.substring(index + 1)
                                                                                                  .trim()));
        }
        catch (final Exception exception)
        {
    ...
    public static BigRational subtract(final BigRational rational1, final BigRational rational2)
    {
        ...
        return BigRational.createRational(rational1.numerator.multiply(rational2.denominator)
                                                             .subtract(
                                                                     rational2.numerator.multiply(rational1.denominator)),
                                          rational1.denominator.multiply(rational2.denominator));
    }
    ...
    public static BigRational divide(final BigRational rational1, final BigRational rational2)
    {
        ...
        return BigRational.createRational(rational1.numerator.multiply(rational2.denominator),
                                          rational1.denominator.multiply(rational2.numerator));
    }
    ...
    public boolean equals(final Object obj)
    {
        ...
        return this.numerator.compareTo(other.numerator) == 0;
    }
    ...
    public static BigRational multiply(final BigRational rational1, final BigRational rational2)
    {
        ...
        return BigRational.createRational(rational1.numerator.multiply(rational2.numerator),
                                          rational1.denominator.multiply(rational2.denominator));
    }
     ...
     * If the given integer is negative, {@link #INVALID} will be returned
     *
     * @param rational Rational to powered
     * @param power    Power to raise
     * @return Rational result
     */
    ...
    public BigDecimal value()
    {
        ...
        return UtilMath.bigIntegerToBigDecimal(this.numerator)
                       .divide(UtilMath.bigIntegerToBigDecimal(this.denominator), BigRational.mathContext());
    }
