...
public class DynamicWriteXML
{
     ...
     * @throws IOException On writing header issue
     */
     ...
     *
     * @param outputStream Stream where write
     * @param textSameLine Indicates if text have to be in same line
     * @throws IOException On writing header issue
     */
     ...
     *
     * @param outputStream Stream where write
     * @param compact      Indicates if use compact mode
     * @param textSameLine Indicates if text at same line as its markup. Text will be forced in same line if compact mode
     *                    is {@code true}
     * @throws IOException On writing header issue
     */
     ...
     * @param outputStream     Stream where write
     * @param compact          Indicates if use compact mode
     * @param textSameLine     Indicates if text at same line as its markup. Text will be forced in same line if compact
     *                         mode is {@code true}
     * @param closeWriterAtEnd Indicates if have to close the stream when finish
     * @throws IOException On writing header issue
     */
    public DynamicWriteXML(final OutputStream outputStream, final boolean compact, final boolean textSameLine,
                           final boolean closeWriterAtEnd)
            throws IOException
    {
     ...
     *
     * @return {@code true} if there are more markup to close. {@code false} if this is the last markup close and the the
     * XML
     * writing is finish
     * @throws IOException On writing issue
     */
