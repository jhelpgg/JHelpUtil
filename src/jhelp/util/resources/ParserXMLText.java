        ...
        extends DefaultHandler
{
     ...
     *
     * @param texts     Hash map to fill with associations
     * @param url       Stream where find the XML to parse
     * @param reference Reference to the XML file (XML file identifier)
     */
            ...
            throws SAXException
    {
        ...
        if (ParserXMLText.MARKUP_TEXT.equals(name))
        {
