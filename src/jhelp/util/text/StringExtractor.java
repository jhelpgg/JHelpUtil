...
public class StringExtractor
{
     ...
     * @param returnSeparators Indicates if return separators
     */
    public StringExtractor(final String string, final String separators, final String stringLimiters,
    ...
    public void addOpenCloseIgnore(final char open, final char close)
    {
        ...
        {
            if ((openClose.element1 == open) || (openClose.element2 == open) || (openClose.element1 == close) ||
                    (openClose.element2 == close))
            {
