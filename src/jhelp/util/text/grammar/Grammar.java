        ...
        implements GrammarConstants
{
     ...
     * @param text Text tested
     * @return Created structure
     * @throws GrammarException If text don't respect the rule
     */
    private Structure computeStructure(
            @NotNull
                    Rule rule, final String text) throws GrammarException
    {
     ...
     * @throws GrammarException If stream not a valid grammar rule definition OR input/output issue
     */
     ...
     *
     * @param rule       Rule where add the definition
     * @param definition Definition to parse
     * @param line       Line number in grammar
     * @throws GrammarException If definition if not a valid definition
     */
     ...
     * @throws GrammarException If stream not valid for the grammar OR on any input/output issue
     */
