...
public class ByteArray
{
    ...
    {
        return ((long) this.read() << 56L) | ((long) this.read() << 48L) | ((long) this.read() << 40L) | ((long) this
                .read() << 32L)
    ...
    public <B extends Binarizable> void writeBinarizableList(List<B> list)
    {
        if (list == null)
        {
            this.writeInteger(-1);
    ...
    public <B extends Binarizable> List<B> readBinarizableList(List<B> list) throws Exception
    {
    ...
    public <B extends Binarizable> B readBinarizableNamed() throws Exception
    {
        if (this.read() == 0)
        {
            return null;
        ...
        final String name = this.readString();
        @SuppressWarnings("unchecked")
        final B binarizable = (B) Reflector.newInstance(name);
    ...
    public <B extends Binarizable> void writeBinarizableNamed(final B binarizable)
    {
        if (binarizable == null)
        {
            this.write(0);
        ...
        this.write(1);
        this.writeString(binarizable.getClass()
                                    .getName());
        binarizable.serializeBinary(this);
    }
     ...
     * The number of bytes takes here is 4(Array length)+(NumberOfBoolean)/8, that mean if you have to store several
     * boolean, its
     * more efficient to use this method (Number of byte took for store data are less) if the number of boolean is at
     * least 5.<br>
