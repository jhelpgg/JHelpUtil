        ...
        extends URLConnection
{
     ...
     * @param fileCopy File where write the copy
     * @throws IOException On opening connection issue or the file can't be create
     */
     ...
     * <p>
     * URLConnection objects go through two phases: first they are created, then they are connected. After being created,
     * and
     * before being connected, various options can be specified (e.g., doInput and UseCaches). After connecting, it is an
     * error
     ...
     * <p>
     * This method first determines the content type of the object by calling the <code>getContentType</code> method. If
     * this is
     ...
     * method, the <code>createContentHandler</code> method of that instance is called with the content type as an
     * argument; the
     ...
     * </pre>
     * <p>
     * </blockquote> where &lt;<i>contentType</i>&gt; is formed by taking the content-type string, replacing all slash
     * characters
     * with a <code>period</code> ('.'), and all other non-alphanumeric characters with the underscore character
     * '<code>_</code>
     * '. The alphanumeric characters are specifically the 26 uppercase ASCII letters '<code>A</code>' through '
     * <code>Z</code>',
     * the 26 lowercase ASCII letters '<code>a</code>' through ' <code>z</code>', and the 10 ASCII digits '<code>0</code>'
     * through ' <code>9</code>'. If the specified class does not exist, or is not a subclass of
     * <code>ContentHandler</code>,
     * then an <code>UnknownServiceException</code> is thrown.
     * </ol>
     *
     * @return the object fetched. The <code>instanceof</code> operator should be used to determine the specific kind of
     * object
     * returned.
     * @throws IOException             if an I/O error occurs while getting the content.
     * @throws UnknownServiceException if the protocol does not support the content type.
     ...
     * Retrieves the contents of this URL connection.
     *
     * @param classes the <code>Class</code> array indicating the requested types
     ...
     *
     * @return the content length of the resource that this connection's URL references, or <code>-1</code> if the
     * content length
     * is not known.
     ...
     *
     * @return the sending date of the resource that the URL references, or <code>0</code> if not known. The value
     * returned is
     ...
     * <p>
     * Ths default is "sticky", being a part of the static state of all URLConnections. This flag applies to the next,
     * and all
     ...
     * <p>
     * If called on a connection that sets the same header multiple times with possibly different values, only the last
     * value is
     * returned.
     *
     ...
     * <p>
     * This form of <code>getHeaderField</code> exists because some connection types (e.g., <code>http-ng</code>) have
     * pre-parsed
     * headers. Classes for that connection type can override this method and short-circuit the parsing.
     *
     * @param name    the name of the header field.
     * @param Default a default value.
     * @return the value of the field, parsed as a date. The value of the <code>Default</code> argument is returned if
     * the field
     ...
     * @return the value of the named field, parsed as an integer. The <code>Default</code> value is returned if the
     * field is
     ...
     * SocketTimeoutException can be thrown when reading from the returned input stream if the read timeout expires
     * before data
    ...
    /**
     * Returns a permission object representing the permission necessary to make the connection represented by this
     * object. This
     ...
     * <p>
     * The permission returned may dependent upon the state of the connection. For example, the permission before
     * connecting may
     * be different from that after connecting. For example, an HTTP sever, say foo.com, may redirect the connection to a
     * different host, say bar.com. Before connecting the permission returned by the connection will represent the
     * permission
     * needed to connect to foo.com, while the permission returned after connecting will be to bar.com.
     * <p>
     * Permissions are generally used for two purposes: to protect caches of objects obtained through URLConnections,
     * and to
     * check the right of a recipient to learn about a particular URL. In the first case, the permission should be obtained
     * <em>after</em> the object has been obtained. For example, in an HTTP connection, this will represent the
     * permission to
     * connect to the host from which the data was ultimately fetched. In the second case, the permission should be
     * obtained and
     ...
     * URLConnection.
     * @throws IOException if the computation of the permission requires network or file I/O and an exception occurs
     *                     while computing
     *                     it.
     ...
     * referenced
     * by this URLConnection. If the timeout expires before the connection can be established, a java.net
     * .SocketTimeoutException
     * is raised. A timeout of zero is interpreted as an infinite timeout.
     * <p>
     * Some non-standard implmentation of this method may ignore the specified timeout. To see the connect timeout set,
     * please
     * call getConnectTimeout().
     *
     * @param timeout an <code>int</code> that specifies the connect timeout value in milliseconds
     ...
     * <p>
     * Some non-standard implementation of this method ignores the specified timeout. To see the read timeout set, please
     * call
     * getReadTimeout().
     *
     * @param timeout an <code>int</code> that specifies the timeout value to be used in milliseconds
     * @throws IllegalArgumentException if the timeout parameter is negative
     * @see #getReadTimeout()
     * @see InputStream#read()
     ...
     * <p>
     * Some protocols do caching of documents. Occasionally, it is important to be able to "tunnel through" and ignore
     * the caches
     * (e.g., the "reload" button in a browser). If the UseCaches flag on a connection is true, the connection is allowed
     * to use
     * whatever caches it can. If false, caches are to be ignored. The default value comes from DefaultUseCaches, which
     * defaults
     * to true.
     *
