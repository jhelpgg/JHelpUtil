 ...
 * Like {@link Binarizable} any extension of this class MUST have a default empty constructor (This one is called when
 * transfer).<br>
 * It also design to be evolutive, that is to say if in one version you decide an element is a <b>boolean</b> by
 * exemple, and
        ...
        implements Binarizable
{
    ...
    {
        this.elements = new HashMap<String, HashmapedBinarizable.Element>();
     ...
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a {@link Binarizable} and
     *                     the convertion is
     ...
     *
     * @param name      Name of the element to convert
     * @param value     Actual element value
     * @param actual    Actual element type
     ...
     * @throws IllegalArgumentException If exists an type not coorect
     */
     ...
     *
     * @param element Elemnt tested
     * @param type    Desired type
     * @throws IllegalArgumentException If the type didn't match
     */
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a
     *                     {@link Binarizable Binarizable[]} and the
    ...
    /**
     * Force get a boolean value. If the value is not a boolean {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a boolean and the
     *                     convertion is not allowed
     *                     or impossible
     * @return Element value
     */
    ...
    /**
     * Force get a boolean[] value. If the value is not a boolean[] {@link #convert(String, Object, Type, Type)} is
     * called to try
     * to convert it
     *
     * @param name         Element name
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a byte and the convertion
     *                     is not allowed or
     *                     impossible
     * @return Element value
     */
    ...
    /**
     * Force get a byte[] value. If the value is not a byte[] {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a char and the convertion
     *                     is not allowed or
     *                     impossible
     * @return Element value
     */
    ...
    /**
     * Force get a char[] value. If the value is not a char[] {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
    ...
    /**
     * Force get a double value. If the value is not a double {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a double and the convertion
     *                     is not allowed or
     *                     impossible
     * @return Element value
     */
    ...
    /**
     * Force get a double[] value. If the value is not a double[] {@link #convert(String, Object, Type, Type)} is called
     * to try
     * to convert it
     *
     * @param name         Element name
    ...
    /**
     * Force get a float value. If the value is not a float {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a float and the convertion
     *                     is not allowed or
     *                     impossible
     * @return Element value
     */
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a float[] and the
     *                     convertion is not allowed
     *                     or impossible
     * @return Element value
     */
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a int and the convertion
     *                     is not allowed or
     *                     impossible
     * @return Element value
     */
    ...
    /**
     * Force get a int[] value. If the value is not a int[] {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a long and the convertion
     *                     is not allowed or
     *                     impossible
     * @return Element value
     */
    ...
    /**
     * Force get a long[] value. If the value is not a long[] {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a long[] and the
     *                     convertion is not allowed or
     *                     impossible
     * @return Element value
     */
    protected final long[] forceGet(final String name, final long[] defaultValue)
    ...
    /**
     * Force get a short value. If the value is not a short {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a short and the convertion
     *                     is not allowed or
     *                     impossible
     * @return Element value
     */
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a short[] and the
     *                     convertion is not allowed
     *                     or impossible
     * @return Element value
     */
    ...
    /**
     * Force get a String value. If the value is not a String {@link #convert(String, Object, Type, Type)} is called to
     * try to
     * convert it
     *
     * @param name         Element name
     * @param defaultValue Value to return if the element doesn't exist or if the type is not a String and the
     *                     convertion is not allowed or
     *                     impossible
     * @return Element value
     */
    ...
    /**
     * Force get a String[] value. If the value is not a String[] {@link #convert(String, Object, Type, Type)} is called
     * to try
     * to convert it
     *
     * @param name         Element name
     ...
     *
     * @param name         Element name
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a {@link Binarizable}
     */
    ...
    /**
     * Obtain a {@link Binarizable Binarizable[]} element. If the element is not a {@link Binarizable Binarizable[]} an
     * exception
     * is throw
     *
     * @param name         Element name
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a {@link Binarizable Binarizable[]}
     */
    protected final Binarizable[] get(final String name, final Binarizable[] defaultValue)
    {
        if (name == null)
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a boolean
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a byte
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a char
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a double
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a float
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a int
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a long
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a short
     */
     ...
     * @param defaultValue Value to return if element does'nt exist
     * @return Element value
     * @throws IllegalArgumentException If the elemnt is not a String
     */
    ...
    public final void parseBinary(final ByteArray byteArray)
    {
        ...
        while (this.readNextElement(byteArray))
        {
            //Consumed in condition
        }
    }
    ...
    public final void serializeBinary(final ByteArray byteArray)
    {
        ...
        for (final String name : this.elements.keySet())
        {
            ...
            {
                case ARRAY_OF_BINARIZABLE:
                    byteArray.writeString(element.value.getClass()
                                                       .getComponentType()
                                                       .getName());
