...
public class UniformResourceIdentifier
{
    ...
    public boolean equals(final Object object)
    {
        ...
        if (!(object instanceof UniformResourceIdentifier))
        {
            return false;
        }
        ...
        if (!ReferencePath.areSamePath(this.path, uri.path))
        {
            return false;
        }
        ...
        return this.fragment.equals(uri.fragment);
    }
