...
public class Authority
{
    ...
    public Authority(final String userInfo, final String host, final int port)
    {
        ...
        if ((userInfo != null) && ((userInfo.indexOf('@') >= 0) || (userInfo.indexOf(':') >= 0) || (userInfo.indexOf(
                '/') >= 0)))
        {
            throw new IllegalArgumentException(
                    "@ : AND / are reserved characters and can't be used in user information ->" + userInfo);
        }
    ...
    public boolean equals(final Object object)
    {
        ...
        if ((this.userInfo != null) && (!this.userInfo.equals(authority.userInfo)))
        {
            return false;
        }

        return (this.host.equals(authority.host)) && (this.port == authority.port);
    }
