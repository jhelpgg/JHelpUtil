...
/**
 * Helper for write messages in pipe.<br>
 * It manage a queue of message, so you don't have to care about waiting writer is ready, its done for you<br>
 * <br>
 * 1) What is a pipe ?<br>
 * <br>
 * A pipe is a way to commuicate between two differents java application, that not neccessary use the same main process,
 * but
 ...
 * <br>
 * Choose a deticated directory, this directory will be change durring time, so don't use this directory for other stuff
 * . Then
 ...
 *
 * @param <BINARIZABLE> Message type
 * @author JHelp
 */
        ...
        implements Runnable
{
     ...
     *
     * @param pipeWriter Pipe writer to use
     */
    public PipeWriterManager(final PipeWriter pipeWriter)
    {
        if (pipeWriter == null)
        {
            throw new NullPointerException("pipeWriter MUST NOT be null");
        }
