...
/**
 * Listener of messages read on pipe by {@link PipeReaderManager}<br>
 * <br>
 * 1) What is a pipe ?<br>
 * <br>
 ...
 *           Message type
 */
public interface PipeReaderManagerListener<BINARIZABLE extends Binarizable>
{
    /**
     * Called when a new message arrive
     *
     * @param pipeReader
     *           Pipe reader that read the message
     * @param message
     *           Message read
     */
    public void receiveMessageFromPipe(PipeReader pipeReader, BINARIZABLE message);
}