 ...
 * 1) What is a pipe ?<br>
 * <br>
 * A pipe is a way to communicate between two different java application, that not necessary use the same main process, but
        ...
        extends PipeCommons
{
     ...
     *
     * @param pipeDirectory Pipe directory
     */
     ...
     * The size is only use on first pipe writing, when pipe already exists, the size is ignored
     *
     * @param pipeDirectory Pipe directory
     * @param pipeSize      Pipe size if pipe not already exists
     */
     ...
     *
     * @param <B>         Message type
     * @param binarizable Message to write
     * @throws PipeException On writing issue
     */
     ...
     * @throws PipeException On wrting issue
     */
