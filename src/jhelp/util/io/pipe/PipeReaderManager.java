...
public class PipeReaderManager<BINARIZABLE extends Binarizable>
{
    ...
    public PipeReaderManager(final Class<BINARIZABLE> binarizebleClass, final PipeReader pipeReader)
    {
        ...
        {
            throw new NullPointerException("binarizebleClass MUST NOT be null");
        }

        if (pipeReader == null)
        {
            throw new NullPointerException("pipeReader MUST NOT be null");
        }
    ...
    void signalToListenersMessage(final BINARIZABLE message)
    {
        synchronized (this.listeners)
        {
            ...
            {
                ThreadManager.THREAD_MANAGER.doThread(this.taskSignalListener,
                                                      new Triplet<PipeReaderManagerListener<BINARIZABLE>, PipeReader,
                                                              BINARIZABLE>(
            ...
            extends ThreadedSimpleTask<PipeReader>
    {
        ...
        protected void doSimpleAction(final PipeReader parameter)
        {
            ...
            {
                if (PipeReaderManager.this.alive.get())
                {
