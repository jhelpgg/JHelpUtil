        ...
        extends InputStream
{
     ...
     * @param outputStream Stream where copy
     */
     ...
     *
     * @param b   Array to fill
     * @param off Offset to start to read
     ...
     * blocking by
     * the next invocation of a method for this input stream. The next invocation might be the same thread or another
     * thread. A
     ...
     * many will
     * not. It is never correct to use the return value of this method to allocate a buffer intended to hold all data in
     * this
     * stream.
     * <p>
     * A subclass' implementation of this method may choose to throw an {@link IOException} if this input stream has been
     * closed
