        ...
        extends OutputStream
{
     ...
     *
     * @param destination Normal destination
     * @param copy        Output stream where copy whats write
     */
     ...
     * @throws IOException On wrinting issue
     ...
     * @throws IOException On writing issues
     ...
     *
     * @param b   Byte array to write
     * @param off Index where start to read the byte array for writing
     * @param len Number of bytes of the byte array to write
