...
public final class Utilities
{
     ...
     * Start is automaticaly put inside source array, that is to say, if start is lower than 0, start will be considered
     * as 0.<br>
     ...
     * Start and end index are automaticaly put inside source array, that is to say, if start is lower than 0, start
     * will be
    ...
    /**
     * Obtain a character index inside a character array. If the character doesn't contains the searched charcter, -1 is
     * return
     *
