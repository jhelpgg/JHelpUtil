        ...
        extends Block
{
     ...
     *
     * @param colorResolution Global color resolution
     */
    ImageDescriptorBlock(final int colorResolution)
    {
     ...
     */
    private Pair<Integer, SubBlock> getCode(final int codeSize, final int codeMask, final InputStream inputStream,
     ...
     */
    private void initializeStringTable(final int[] prefix, final byte[] suffix, final byte[] initial, final int[] length,
                                       final int lzwCode)
    {
