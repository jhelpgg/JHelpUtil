...
interface GIFConstants
{
   ...
   public static final int    BLOCK_EXTENTION                          = 0x21;
   /** The Application Extension contains application-specific information */
   public static final int    BLOCK_EXTENTION_APPLICATION              = 0xFF;
   /**
    * The Comment Extension contains textual information which is not part of the actual graphics in the GIF Data Stream. It is
    * suitable for including comments about the graphics, credits, descriptions or any other type of non-control and non-graphic
    * data.
    */
   public static final int    BLOCK_EXTENTION_COMMENT                  = 0xFE;
   /** The Graphic Control Extension contains parameters used when processing a graphic rendering block */
   public static final int    BLOCK_EXTENTION_GRAPHIC_CONTROL          = 0xF9;
   /**
    * The Plain Text Extension contains textual data and the parameters necessary to render that data as a graphic, in a simple
    * form.
    */
   public static final int    BLOCK_EXTENTION_PLAIN_TEXT               = 0x01;
   ...
   public static final int    DISPSOAL_METHOD_NOT_DISPOSE              = 1;
   /** Restore to background color. The area used by the graphic must be restored to the background color. */
   public static final int    DISPSOAL_METHOD_RESTORE_BACKGROUND_COLOR = 2;
   /**
    * Restore to previous. The decoder is required to restore the area overwritten by the graphic with what was there prior to
    * rendering the graphic.
    */
   public static final int    DISPSOAL_METHOD_RESTORE_PREVIOUS         = 3;
   /** No disposal specified. The decoder is not required to take any action. */
   public static final int    DISPSOAL_METHOD_UNSPECIFIED              = 0;
   /** GIF header */
   ...
   public static final int    MASK_GLOABAL_COLOR_TABLE_ORDERED         = 0x08;
   /** Mask used for extract global color table size from flags : b00000111 */
   public static final int    MASK_GLOABAL_COLOR_TABLE_SIZE            = 0x07;
