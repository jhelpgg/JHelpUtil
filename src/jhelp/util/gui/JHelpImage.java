        ...
        implements ConstantsGUI, HeavyObject, RasterImage, Icon
{
     ...
     */
    private void fillRectangleScale(final int x, final int y, final int width, final int height, final int[] pixels,
     ...
     * @return Bumped image
     */
    public static JHelpImage createBumpedImage(final JHelpImage source, final JHelpImage bump, double contrast,
     ...
     */
    public static boolean doesImagesLookSamePerBorder(JHelpImage image1, JHelpImage image2, final int precision,
     ...
     * @return {@code true} if images "look" the same
     */
    public static boolean doesImagesLookSamePerLuminosity(JHelpImage image1, JHelpImage image2, final int precision,
                                                          final int percentDifferenceAccepted)
    {
        final int width1  = image1.width;
        final int height1 = image1.height;
     ...
     * @return {@code true} if images "look" the same
     */
    public static boolean doesImagesLookSamePerPixel(JHelpImage image1, JHelpImage image2, int colorPartPrecision,
     ...
     * @param forced  Indicated that the changes is forced
     */
    void changeSpriteVisibility(final int index, final boolean visible, final boolean forced)
    {
        if (this.drawMode)
        {
        ...
        for (int i = length - 1; i > index; i--)
        {
            ...
            isVisible = visibles[i] = sprite.isVisible();
            ...
            for (int x = 0; x < this.width; x++)
            {
                ...
                this.pixels[p] =
                        ...
                        (((((c00 >> 24) & 0xFF) + (((c10 >> 24) & 0xFF) << 1) + ((c20 >> 24) & 0xFF) + //
                                   (((c01 >> 24) & 0xFF) << 1) + (((c11 >> 24) & 0xFF) << 2) + (((c21 >> 24) & 0xFF) <<
                                                                                                        1) + //
                                   ((c02 >> 24) & 0xFF) + (((c12 >> 24) & 0xFF) << 1) + ((c22 >> 24) & 0xFF)) >> 4) <<
                                 24) | //
                                // Red
                                (((((c00 >> 16) & 0xFF) + (((c10 >> 16) & 0xFF) << 1) + ((c20 >> 16) & 0xFF) + //
                                           (((c01 >> 16) & 0xFF) << 1) + (((c11 >> 16) & 0xFF) << 2) + (((c21 >> 16) &
                                                                                                                 0xFF)
                                                                                                                << 1) + //
                                           ((c02 >> 16) & 0xFF) + (((c12 >> 16) & 0xFF) << 1) + ((c22 >> 16) & 0xFF)) >>
                                          4) << 16)
                                | //
                                // Green
                                (((((c00 >> 8) & 0xFF) + (((c10 >> 8) & 0xFF) << 1) + ((c20 >> 8) & 0xFF) + //
                                           (((c01 >> 8) & 0xFF) << 1) + (((c11 >> 8) & 0xFF) << 2) + (((c21 >> 8) &
                                                                                                               0xFF) <<
                                                                                                              1) + //
                                           ((c02 >> 8) & 0xFF) + (((c12 >> 8) & 0xFF) << 1) + ((c22 >> 8) & 0xFF)) >> 4)
                                         << 8)
                                | //
                                // Blue
        ...
        for (int pix = size - 1; pix >= 0; pix--)
        {
            if (result[pix] == 0)
            {
                ...
                while (!stack.isEmpty())
                {
                    ...
                    if ((point.x > 0) && (result[p - 1] == 0) && (Color.isNear(red, green, blue, this.pixels[p - 1],
                                                                               precision)))
                    {
                        stack.push(new Point(point.x - 1, point.y));
                    }

                    if ((point.y > 0) && (result[p - this.width] == 0) && (Color.isNear(red, green, blue,
                                                                                        this.pixels[p - this.width],
                                                                                        precision)))
                    {
                        stack.push(new Point(point.x, point.y - 1));
                    }

                    if ((point.x < (this.width - 1)) && (result[p + 1] == 0) && (Color.isNear(red, green, blue,
                                                                                              this.pixels[p + 1],
                                                                                              precision)))
                    {
                        stack.push(new Point(point.x + 1, point.y));
    ...
    public void contrast(final double factor)
    {
        ...
        for (int i = this.pixels.length - 1; i >= 0; i--)
        {
            ...
            this.pixels[i] = (color & 0xFF000000) | (JHelpImage.computeRed(y, u, v) << 16) | (JHelpImage.computeGreen(y, u,
                                                                                                                      v)
                                                                                                      << 8)
                    | JHelpImage.computeBlue(y, u, v);
        }
     ...
     */
    public Pair<JHelpSprite, JHelpAnimatedImage> createAnimatedSprite(final int x, final int y, final int width, final
    int height,
    ...
    public JHelpMask createMask(final int positiveColor, int precision)
    {
        ...
        for (int y = 0; y < this.height; y++)
        {
            for (int x = 0; x < this.width; x++)
            {
                ...
                if ((Math.abs(alpha - a) <= precision) && (Math.abs(red - r) <= precision) && (Math.abs(
                        green - g) <= precision)
     ...
     */
    public void drawEllipse(final int x, final int y, final int width, final int height, final int color, final boolean
            doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void drawImage(final int x, final int y, final JHelpImage image, final int xImage, final int yImage, final int
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    void drawImageInternal(int x, int y, final JHelpImage image, int xImage, int yImage, int width, int height, final
    boolean doAlphaMix)
    {
        if (!doAlphaMix)
        {
            ...
            for (int xx = 0; xx < w; xx++)
            {
                ...
                else if (alpha > 0)
                {
                    ...
                    this.pixels[pixThis] = (Math.min(255, alpha + ((colorThis >> 24) & 0xFF)) << 24) | //
                            ((((((colorImage >> 16) & 0xFF) * alpha) + (((colorThis >> 16) & 0xFF) * ahpla)) >> 8) <<
                                     16) | //
     ...
     * @param alpha  Alpha to use
     */
    void drawImageInternal(int x, int y, final JHelpImage image, int xImage, int yImage, int width, int height, final int
            alpha)
    {
        if (alpha == 255)
        {
     ...
     * @param height Part height
     */
    public void drawImage(final int x, final int y, final JHelpImage image, final int xImage, final int yImage,
     ...
     * @param pixelCombination Pixel combination to use
     */
    public void drawImage(int x, int y, final JHelpImage image, int xImage, int yImage, int width, int height, final
     ...
     * @param doAlphaMix     Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void drawImage(int x, int y, final JHelpImage image, final Transformation transformation, final boolean
            doAlphaMix)
    {
        if (!this.drawMode)
        {
                ...
                if ((tx >= this.clip.xMin) && (tx <= this.clip.xMax) && (ty >= this.clip.yMin) && (ty <= this.clip.yMax))
                {
                    ...
                    else if (alpha > 0)
                    {
                        ...
                        this.pixels[pixThis] = (Math.min(255, alpha + ((colorThis >> 24) & 0xFF)) << 24) | //
                                ((((((colorImage >> 16) & 0xFF) * alpha) + (((colorThis >> 16) & 0xFF) * ahpla)) >> 8)
                                         << 16) | //
                                ((((((colorImage >> 8) & 0xFF) * alpha) + (((colorThis >> 8) & 0xFF) * ahpla)) >> 8) <<
                                         8) | //
                                ((((colorImage & 0xFF) * alpha) + ((colorThis & 0xFF) * ahpla)) >> 8);
                    }
                }
        ...
        do
        {
            for (int index = start; index < limit; index++)
            {
                ...
                this.drawThickLine((int) Math.round(segment.x1), (int) Math.round(segment.y1),
                                   (int) Math.round(segment.x2), (int) Math.round(segment.y2), thin,
                                   color);
            }
     ...
     * @param doAlphaMix   Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void drawPath(final Path path, final JHelpImage elementDraw, final double percentStart, final double percentEnd,
                         final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param color   Color to use
     */
    public void drawPolygon(final int[] xs, final int offsetX, final int[] ys, final int offsetY, final int length,
                            final int color)
    {
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void drawPolygon(final int[] xs, int offsetX, final int[] ys, int offsetY, int length, final int color,
                            final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param color     Color to use
     */
    public void drawRoundRectangle(final int x, final int y, final int width, final int height, final int arcWidth,
     ...
     */
    public void drawThickEllipse(final int x, final int y, final int width, final int height, final int thickness,
                                 final int color)
    {
        if (!this.drawMode)
        {
     ...
     */
    public void drawThickLine(final int x1, final int y1, final int x2, final int y2, final int thickness,
                              final JHelpImage texture)
    {
                ...
                if (shape.contains(xx, yy))
                {
                    ...
                    else if (alpha > 0)
                    {
                        ...
                        this.pixels[pix] = (Math.min(255, alpha + ((color >> 24) & 0xFF)) << 24) | //
                                ((((((colorTexture >> 16) & 0xFF) * alpha) + (((color >> 16) & 0xFF) * ahpla)) >> 8) <<
                                         16) | //
     ...
     */
    public void drawThickLine(final int x1, final int y1, final int x2, final int y2, final int thickness, final
    JHelpPaint paint)
    {
            ...
            for (int xx = startX, xPaint = startXPaint; xx <= endX; xx++, xPaint++)
            {
                if (shape.contains(xx, yy))
                {
                    ...
                    else if (alpha > 0)
                    {
                        ...
                        this.pixels[pix] = (Math.min(255, alpha + ((color >> 24) & 0xFF)) << 24) | //
                                ((((((colorPaint >> 16) & 0xFF) * alpha) + (((color >> 16) & 0xFF) * ahpla)) >> 8) <<
                                         16) | //
     ...
     * @param color     Color to use
     */
    public void drawThickPolygon(final int[] xs, int offsetX, final int[] ys, int offsetY, int length, final int
            thickness, final int color)
    {
        if (!this.drawMode)
        {
            throw new IllegalStateException("Must be in draw mode !");
     ...
     */
    public void drawThickPolygon(final int[] xs, int offsetX, final int[] ys, int offsetY, int length, final int thickness,
                                 final JHelpImage texture)
    {
        if (!this.drawMode)
        {
     ...
     * @param color     Color to use on border
     */
    public void drawThickRectangle(final int x, final int y, final int width, final int height, final int thickness,
                                   final int color)
    {
     ...
     * @param color     Color to use on border
     */
    public void drawThickRoundRectangle(final int x, final int y, final int width, final int height, final int arcWidth,
                                        final int arcHeight,
    ...
    public void fillColor(final int x, final int y, final int color, int precision, final boolean alphaMix)
    {
        ...
        if ((alpha == 255) || (!alphaMix))
        {
            ...
            while (!stack.isEmpty())
            {
                ...
                if ((point.x > 0) && (JHelpImage.distanceColor(start,
                                                               this.pixels[(point.x - 1) + (point.y * this.width)]) <=
                                              precision))
                {
                    stack.push(new Point(point.x - 1, point.y));
                }
                ...
                if ((point.x < (this.width - 1)) && (JHelpImage.distanceColor(start,
                                                                              this.pixels[point.x + 1 + (point.y * this
                                                                                      .width)]) <= precision))
                {
                    stack.push(new Point(point.x + 1, point.y));
                }
                ...
                if ((point.y > 0) && (JHelpImage.distanceColor(start,
                                                               this.pixels[point.x + ((point.y - 1) * this.width)]) <=
                                              precision))
                {
                    stack.push(new Point(point.x, point.y - 1));
                }
        ...
        while (!stack.isEmpty())
        {
            ...
            if ((point.y < (this.height - 1)) && (JHelpImage.distanceColor(start,
                                                                           this.pixels[point.x + ((point.y + 1) * this
                                                                                   .width)]) <= precision))
            {
                stack.push(new Point(point.x, point.y + 1));
            }
    ...
    {
        return UtilMath.maxIntegers(Math.abs(((color1 >> 16) & 0xFF) - ((color2 >> 16) & 0xFF)),
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void fillEllipse(final int x, final int y, final int width, final int height, final int color, final boolean
            doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void fillEllipse(final int x, final int y, final int width, final int height, final JHelpImage texture, final
    boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param color   Color to use
     */
    public void fillPolygon(final int[] xs, final int offsetX, final int[] ys, final int offsetY, final int length, final
    int color)
    {
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void fillPolygon(final int[] xs, int offsetX, final int[] ys, int offsetY, int length, final int color, final
    boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void fillPolygon(final int[] xs, int offsetX, final int[] ys, int offsetY, int length, final JHelpImage
            texture, final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
            throw new IllegalStateException("Must be in draw mode !");
     ...
     * @param doAlphaMix Indicates if do alpha mixing or just overwrite
     */
    public void fillPolygon(final int[] xs, int offsetX, final int[] ys, int offsetY, int length, final JHelpPaint paint,
                            final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
                              ...
                              final boolean doAlphaMix)
    {
        ...
        final int startX = UtilMath.maxIntegers(this.clip.xMin, x, 0);
        final int endX   = UtilMath.minIntegers(this.clip.xMax, x2, this.width - 1);
        final int startY = UtilMath.maxIntegers(this.clip.yMin, y, 0);
     ...
     * @param texture Image to draw
     */
    public void fillRectangleScaleBetter(final int x, final int y, final int width, final int height,
                                         final JHelpImage texture)
    {
     ...
     * @param doAlphaMix Indicates if we do the mixing {@code true}, or we just override {@code false}
     */
    public void fillRectangleScaleBetter(final int x, final int y, final int width, final int height, final JHelpImage
            texture, final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
        ...
        graphics2d.setRenderingHint(RenderingHints.KEY_ALPHA_INTERPOLATION, RenderingHints
     ...
     * @param texture   Texture to use
     */
    public void fillRoundRectangle(final int x, final int y, final int width, final int height, final int arcWidth, final
    int arcHeight,
                                   final JHelpImage texture)
    {
     ...
     */
    public void fillRoundRectangle(final int x, final int y, final int width, final int height, final int arcWidth, final
    int arcHeight, final JHelpPaint paint)
    {
     ...
     */
    public void fillRoundRectangle(final int x, final int y, final int width, final int height, final int arcWidth,
                                   final int arcHeight, final JHelpPaint paint,
                                   final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
                                ...
                                final boolean doAlphaMix)
    {
        ...
        final Pair<List<JHelpTextLineAlpha>, Dimension> lines = font.computeTextLinesAlpha(string, textAlign, this.width -
     ...
     * @return Bounds where string just draw
     */
    public Rectangle fillString(final int x, final int y, final String string, final JHelpFont font,
     ...
     * @return Bounds where string just draw
     */
    public Rectangle fillString(final int x, final int y, final String string, final JHelpFont font, final JHelpImage
            texture, final int color,
                                final boolean doAlphaMix)
    {
    ...
    public void grayInvert()
    {
        ...
        for (int i = this.pixels.length - 1; i >= 0; i--)
        {
            ...
            y = 255 - UtilMath.limit0_255((int) (JHelpImage.computeY((color >> 16) & 0xFF, (color >> 8) & 0xFF, color &
                    0xFF)));
    ...
    public void invertUV()
    {
        ...
        for (int i = this.pixels.length - 1; i >= 0; i--)
        {
            ...
            this.pixels[i] = (color & 0xFF000000) | (JHelpImage.computeRed(y, v, u) << 16) | (JHelpImage.computeGreen(y, v,
                                                                                                                      u)
                                                                                                      << 8)
     ...
     */
    public void paintAlphaMask(int x, int y, final JHelpImage alphaMask, final int color, final int background,
                               final boolean doAlphaMix)
    {
     ...
     * @param doAlphaMix Indicates if do alpha mixing ({@code true}) or just overwrite ({@code false})
     */
    public void paintMask(int x, int y, final JHelpMask mask, final int foreground, final int background,
                          final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param doAlphaMix  Indicates if do alpha mixing ({@code true}) or just overwrite ({@code false})
     */
    public void paintMask(int x, int y, final JHelpMask mask, final int foreground, final JHelpImage background,
     ...
     * @param doAlphaMix Indicates if do alpha mixing ({@code true}) or just overwrite ({@code false})
     */
    public void paintMask(int x, int y, final JHelpMask mask, final int foreground, final JHelpPaint background,
                          final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param doAlphaMix  Indicates if do alpha mixing ({@code true}) or just overwrite ({@code false})
     */
    public void paintMask(int x, int y, final JHelpMask mask, final JHelpImage foreground, int foregroundX,
     ...
     * @param doAlphaMix Indicates if do alpha mixing ({@code true}) or just overwrite ({@code false})
     */
    public void paintMask(int x, int y, final JHelpMask mask, final JHelpPaint foreground, final int background,
                          final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param doAlphaMix  Indicates if do alpha mixing ({@code true}) or just overwrite ({@code false})
     */
    public void paintMask(int x, int y, final JHelpMask mask, final JHelpPaint foreground, final JHelpImage background,
                          int backgroundX, int backgroundY,
                          final boolean doAlphaMix)
    {
        if (!this.drawMode)
     ...
     * @param doAlphaMix Indicates if do alpha mixing ({@code true}) or just overwrite ({@code false})
     */
    public void paintMask(int x, int y, final JHelpMask mask, final JHelpPaint foreground, final JHelpPaint background,
                          final boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     */
    public void repeatOnLine(final int x1, final int y1, final int x2, final int y2, final JHelpImage image, final
    boolean doAlphaMix)
    {
        if (!this.drawMode)
        {
     ...
     * @param doAlphaMix Indicates if we do alpha mixing
     */
    public void repeatOnLineVertical(final int x, final int y1, final int y2, final JHelpImage image, final boolean
            doAlphaMix)
    {
    ...
    public void replaceColor(final int colorToReplace, final int newColor, final int near)
    {
        ...
        for (int i = this.pixels.length - 1; i >= 0; i--)
        {
            ...
            if ((Math.abs(((colorToReplace >> 24) & 0xFF) - ((color >> 24) & 0xFF)) <= near)
                    ...
                    && (Math.abs(((colorToReplace >> 8) & 0xFF) - ((color >> 8) & 0xFF)) <= near) && (Math.abs(
                    (colorToReplace & 0xFF) - (color & 0xFF)) <= near))
            {
    ...
    public void tint(final int colorHigh, final int colorLow)
    {
        ...
        for (int pix = this.pixels.length - 1; pix >= 0; pix--)
        {
            ...
            gray = col & 0xFF;
            yarg = 256 - gray;
            this.pixels[pix] = (col & 0xFF000000) | ((((redHigh * gray) + (redLow * yarg)) >> 8) << 16) | ((((greenHigh
                                                                                                                      *
                                                                                                                      gray) + (greenLow * yarg)) >> 8) << 8)
