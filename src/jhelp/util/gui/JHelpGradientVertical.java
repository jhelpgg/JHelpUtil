 ...
 * @author JHelp
 */
public class JHelpGradientVertical
      implements JHelpPaint
{
    ...
    *           Color at end (down)
    */
   public JHelpGradientVertical(final int colorStart, final int colorEnd)
   {
      this.percents = new SortedArray<JHelpGradientVertical.Percent>(Percent.class);
   ...
   {
      final int yy = (y * 100) / this.height;
      final Percent per = new Percent(yy, 0);
