        ...
        implements Comparable<LapsTime>
{
     ...
     * It's made in way the you can use safely the same instance in <code>lapsTime1</code> and/or <code>lapsTime2</code>
     * and/or
     * <code>result</code>
     *
     * @param lapsTime1 First laps time
     * @param lapsTime2 Second laps time
     * @param result    For collect result. If {@code null}, it create a new instance
     * @return Result
     */
    public static LapsTime addition(final LapsTime lapsTime1, final LapsTime lapsTime2, LapsTime result)
    {
        if (lapsTime1 == null)
        {
            throw new NullPointerException("lapsTime1 MUST NOT be null");
        }
        if (lapsTime2 == null)
        {
            throw new NullPointerException("lapsTime2 MUST NOT be null");
        }
        if (result == null)
        {
            result = new LapsTime();
     ...
     *
     * @param lapsTime Laps time to divide
    ...
    public static LapsTime divide(final LapsTime lapsTime, final int factor, LapsTime result)
    {
        if (lapsTime == null)
        {
            throw new NullPointerException("lapsTime MUST NOT be null");
        }
        if (factor < 0)
        {
     ...
     *
     * @param microsecond Microseconds to add
     */
     ...
     *
     * @param millisecond Microseconds to add
     */
     ...
     *
     * @param lapsTime Laps time to compare with
     ...
     * Modify microsecond
     *
     * @param microsecond New microsecond value
     */
     ...
     *
     * @param milliseconds New time in millsenconds
     */
    ...
    public String shortString()
    {
        ...
        if ((force) || (this.millisecond > 0))
        {
            if ((force) && (this.millisecond < 100))
            {
                stringBuilder.append('0');
            }

            if ((force) && (this.millisecond < 10))
            {
                stringBuilder.append('0');
            }
        ...
        if ((force) && (this.microsecond < 100))
        {
            stringBuilder.append('0');
        }

        if ((force) && (this.microsecond < 10))
        {
            stringBuilder.append('0');
        }
